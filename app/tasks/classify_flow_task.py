...
class ClassifyFlowTask(BaseTask):
    def __init__(self, description, input_raster, classified_layer, classification_table):
    ...
    def task(self):
        classif = ['0', '10000', '-9999', '10000', '20000', '1', '20000', '50000', '2', '50000', '100000',
                   '3', '100000', '500000', '4', '500000', '1000000', '5', '1000000', '1000000000', '6']

        try:
            params = {
                'INPUT_RASTER': self.input_raster,
                'RASTER_BAND': 1,  # Assuming you are classifying the first band
                'TABLE': classif,
            ...
            result = processing.run("qgis:reclassifybytable", params, feedback=feedback)
