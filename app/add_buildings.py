...
from qgis.core import QgsApplication, QgsProject, QgsProcessingFeedback, QgsTask, QgsCoordinateReferenceSystem
...
def main():
    ...
    reference_raster_path = config_analysis['smaller_cut']
    ...
    vectorize_buildings_task = RasterizeVectorTask(
        ...
        reference_raster_path, raster_output_path, crs, height)
