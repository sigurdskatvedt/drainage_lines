...
def main():
    ...
    all_culverts_task = MergeVectorLayersTask(
        "Merge culverts from water and building data",
        all_culverts_name, [
    ...
    culverts_negative_height_task = RasterizeVectorTask(
        ...
        raster_culvert_output_path, crs, height)
    ...
    add_water_task = LoadLayersTask(
        "Loading water data", config_external['water_layer_path'], water_name,
        water_output_name, crs)
    ...
    all_culverts_and_water_task = MergeVectorLayersTask(
        ...
        [all_culverts_name, water_output_name], crs)
    ...
    water_culverts_negative_height_task = RasterizeVectorTask(
        ...
        raster_water_culverts_path, crs, height)
    ...
    add_rasters_culverts_water_task.addSubTask(
        water_culverts_negative_height_task, [],
        QgsTask.ParentDependsOnSubTask)
