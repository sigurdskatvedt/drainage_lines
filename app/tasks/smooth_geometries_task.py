...
class SmoothGeometriesTask(BaseTask):
    ...
    def task(self):
        ...
        try:
            ...
            result = processing.run("native:smoothgeometry", params, feedback=self.feedback)
            ...
            if self.output_vector:
                ...
                return True
            log(f'Task "{self.description()}" encountered an error during geometry smoothing.', level=logging.ERROR)
            return False
